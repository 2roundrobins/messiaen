...
-- bird tables
bird_tab = {bird.wren, bird.robin, bird.trush, bird.gale, bird.blackbird, bird.chaffinch, bird.g_tit, bird.green_finch, bird.willow_warbler, bird.nutchach}
...
function init()
  ...
  -- load file
  load_audio("/dust/code/massiaen/assets/forests/robinwren.wav")
  ...
  params:set_action("load_forest", function(path) load_audio("/home/we/dust/code/massiaen/assets/forests/robinwren.wav") end)
  ...
  params:add_control("forest_level", "level", controlspec.new(0, 1, 'lin', 0, 0.3, ""))
...
function redraw()
  ...
  if garden_is_planted then
    ...
    if is_recording then
      screen.display_png(_path.code .. "/massiaen/assets/brd_pngs/exl.png", 84, 15)
    end
    ...
    elseif active_bird_name =="green finch" then
      if info == true then
        ...
        display_exl = false
        screen.clear()
        screen.display_png(_path.code .. "/massiaen/assets/brd_pngs/green_finch_info.png", 0, 0)
        screen.move(50,9)
        screen.font_size(11)
        screen.font_face(15)
        screen.text("green")
      ...
      elseif info == false then  
        screen.display_png(_path.code .. "/massiaen/assets/brd_pngs/green_finch.png", 38, 18)
        screen.move(65, 10)
    ...
    elseif active_bird_name == "willow warbler" then
      if info == true then
        ...
        display_exl = false
        screen.clear()
        screen.display_png(_path.code .. "/massiaen/assets/brd_pngs/willow_warbler_info.png", 0, 0)
        screen.move(50,9)
        screen.font_size(11)
        screen.font_face(15)
        screen.text("willow")
      ...
      elseif info == false then
        screen.display_png(_path.code .. "/massiaen/assets/brd_pngs/willow_warbler.png", 38, 18)
        screen.move(65, 10)
    ...
    elseif active_bird_name =="nuthach" then
      if info == true then
        ...
        display_exl = false
        screen.clear()
        screen.display_png(_path.code .. "/massiaen/assets/brd_pngs/nuthach_info.png", 0, 0)
        screen.move(50,9)
        screen.font_size(11)
        screen.font_face(15)
        screen.text("nuthach")
      ...
      elseif info == false then
        screen.display_png(_path.code .. "/massiaen/assets/brd_pngs/nuthach.png", 38, 18)
        screen.move(65, 10)
    ...
    elseif active_bird_name =="chaffinch" then
      if info == true then
        ...
        display_exl = false
        screen.clear()
        screen.display_png(_path.code .. "/massiaen/assets/brd_pngs/chaffinch_info.png", 0, 0)
        screen.move(50,9)
        screen.font_size(11)
        screen.font_face(15)
        ...
        screen.text("chaffinch is confident with")
         screen.move(0,60)
        screen.text("it's bold & theatrical ending.")
      elseif info == false then
    ...
    elseif active_bird_name == "trush" then
      if info == true then
        ...
        display_exl = false
        screen.clear()
        screen.display_png(_path.code .. "/massiaen/assets/brd_pngs/trush_info.png", 0, 0)
        screen.move(50,9)
        screen.font_size(11)
        screen.font_face(15)
        screen.text("song")
    ...
    elseif active_bird_name == "robin" then
      if info == true then
        ...
        display_exl = false
        screen.clear()
        screen.display_png(_path.code .. "/massiaen/assets/brd_pngs/robin_info.png", 0, 0)
        screen.move(50,9)
        screen.font_size(11)
        screen.font_face(15)
    ...
    elseif active_bird_name =="nightingale" then
      if info == true then
        ...
        display_exl = false
        screen.clear()
        screen.display_png(_path.code .. "/massiaen/assets/brd_pngs/nightingale_info.png", 0, 0)
        screen.move(50,9)
        screen.font_size(11)
        screen.font_face(15)
    ...
    elseif active_bird_name == "blackbird" then
      if info == true then
        ...
        display_exl = false
        screen.clear()
        screen.display_png(_path.code .. "/massiaen/assets/brd_pngs/blackbird_info.png", 0, 0)
        screen.move(50,9)
        screen.font_size(11)
        screen.font_face(15)
